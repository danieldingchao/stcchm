...
CRYPTO_EXPORT bool des_encrypt(unsigned char key[8], const std::string& input, std::string* output);
CRYPTO_EXPORT bool des_decrypt(unsigned char key[8], const std::string& input, std::string* output);
