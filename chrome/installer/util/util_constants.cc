...
const wchar_t kChromeExe[] = L"lemon.exe";
...
const wchar_t kChromeNewExe[] = L"new_lemon.exe";
const wchar_t kChromeOldExe[] = L"old_lemon.exe";
...
const wchar_t kGoogleChromeInstallSubDir1[] = L"Lemon";
const wchar_t kGoogleChromeInstallSubDir2[] = L"Browser";
